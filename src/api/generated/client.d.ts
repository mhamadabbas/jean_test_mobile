...
export interface OperationMethods {
   ...
   */
  'getInvoice'(
    parameters: Parameters<Paths.GetInvoice.HeaderParameters & Paths.GetInvoice.PathParameters>,
    data?: any,
    config?: AxiosRequestConfig  
   ...
   */
  'putInvoice'(
    parameters: Parameters<Paths.PutInvoice.HeaderParameters & Paths.PutInvoice.PathParameters>,
   ...
   */
  'deleteInvoice'(
    parameters: Parameters<Paths.DeleteInvoice.HeaderParameters & Paths.DeleteInvoice.PathParameters>,
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.DeleteInvoice.Responses.$204>
}
